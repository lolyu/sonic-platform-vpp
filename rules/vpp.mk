...
# under vppbld/plugins/ changes its binary API (.api file) or otherwise alters
# what the vpp/vpp-dev debs ship. The VPP_VERSION_SONIC string is the cache key
...
# pre-date the new patch series and end up with VPP/SAI CRC drift, or miss
# newly generated plugin API headers entirely.
